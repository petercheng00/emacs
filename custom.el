...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (groovy-mode zenburn-theme yasnippet ws-butler use-package undo-tree transpose-frame spaceline smooth-scrolling smartparens rtags rainbow-identifiers rainbow-delimiters pdf-tools org multiple-cursors magit hlinum highlight-indent-guides helm-projectile golden-ratio git-gutter-fringe general-close framemove flycheck fireplace deft company bash-completion avy-zap anzu aggressive-indent ace-window 0xc)))
 '(safe-local-variable-values
   (quote
    ((eval when
           (require
